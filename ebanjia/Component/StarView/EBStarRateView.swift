...
@objc protocol EBStarRateViewDelegate {
    
    @objc optional func starRateView(_ starRateView:EBStarRateView,newScorePercent:CGFloat)->Void
    
}

class EBStarRateView: UIView {
    //MARK : public
    ...
    public weak var delegate:EBStarRateViewDelegate?  //代理
    public var allowGrade = false // 是否允许打分
